...
public class SearchLgn extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.searchlgn);
		district = (Spinner) findViewById(R.id.searchlgn_spinner);
		bloodgrp = (Spinner) findViewById(R.id.searchlgn_spinnerbg);

		home = (Button) findViewById(R.id.searchlgn_home);
		back = (Button) findViewById(R.id.searchlgn_back);

		search = (ImageButton) findViewById(R.id.searchlgn_search);
